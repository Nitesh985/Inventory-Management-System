  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Manage customer credits, track payments, and monitor account balances with comprehensive credit history and transaction recording." />
      </Helmet>
          ...
          <div className="p-4 lg:p-8 max-w-7xl mx-auto">
            ...
            <div className="mb-8">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  <h1 className="text-3xl font-bold text-foreground">Customer Khata</h1>
