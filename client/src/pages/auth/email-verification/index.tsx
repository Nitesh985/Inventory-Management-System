    ...
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <div className="text-center space-y-4 animate-fade-in">
        ...
        <div className="space-y-2">
          <h3 className="text-2xl font-black text-gray-900 bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">Verify Your Email</h3>
      ...
      <div className="space-y-4 animate-fade-in-delay" style={{ animationDelay: '0.1s' }}>
        ...
        <div className="flex justify-center pt-2">
          {resendTimer > 0 ? (
            <p className="text-sm text-gray-600 font-medium">
              Resend code in <span className="font-bold text-blue-600 animate-pulse">{resendTimer}s</span>
            </p>
          ) : (
            <button 
              type="button" 
